...
def test_reviewer_cannot_approve_or_reject(as_reviewer, patch_contrib_crud):
    resp_a = as_reviewer.post("/api/v1/contributions/11111111-1111-1111-1111-111111111111/approve", json={"comment": "ok"})
    resp_r = as_reviewer.post("/api/v1/contributions/11111111-1111-1111-1111-111111111111/reject", json={"reason": "bad"})
...
def test_admin_can_approve_and_reject(as_admin, patch_contrib_crud):
    resp_a = as_admin.post("/api/v1/contributions/22222222-2222-2222-2222-222222222222/approve", json={"comment": "ok"})
    ...
    resp_r = as_admin.post("/api/v1/contributions/33333333-3333-3333-3333-333333333333/reject", json={"reason": "bad"})
